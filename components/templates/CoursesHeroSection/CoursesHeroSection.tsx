...
function CoursesHeroSection() {
  return (
    <div className=" rounded-2xl p-3 my-10 ">
      <div className=" bg-[#EBF9F982] rounded-2xl h-64 absolute w-full  -z-10 "></div>
      ...
      <div className="flex justify-around ">
        ...
        <div id="leftside" className="relative -top-10" >
          <img
            src="/icons/courses hero section shape.png"
            alt="sda"
            className=""
          />
          <img
            src="/icons/backcoursesec.png"
            alt="sda"
